...
import (
	...
	"github.com/zh1014/comment/model/mysql"
)
...
func (cs *CommentService) Insert(targetID, parentID uint64, userID, content string) (uint64, error) {
...
func (cs *CommentService) CommentsByUser(userId string) ([]*mysql.Comment, error) {
