...
func Insert(db *sql.DB, insert string, targetID, parentID, userID uint64, content string) (uint64, error) {
...
func CommentsByUserID(db *sql.DB, commentsByUsers string, userId uint64) ([]*Comment, error) {
	var (
		id       uint64
		targetID uint64
		content  string
