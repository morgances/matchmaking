...
app.model({ namespace: 'activities', ...(require('/Users/a11/Github/group-matchmaking/management/src/pages/HomePage/models/activities.js').default) });
app.model({ namespace: 'chart', ...(require('/Users/a11/Github/group-matchmaking/management/src/pages/HomePage/models/chart.js').default) });
app.model({ namespace: 'onlineRegistration', ...(require('/Users/a11/Github/group-matchmaking/management/src/pages/HomePage/models/onlineRegistration.js').default) });
